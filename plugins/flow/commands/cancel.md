...
allowed-tools: Bash(gh pr view:*), Bash(gh pr comment:*), Bash(gh pr close:*), Bash(git branch:*), Bash(git worktree:*), Bash(git pull:*), Bash(git rev-parse:*), mcp__plugin_linear_linear__update_issue, mcp__claude_ai_Linear__save_issue
---
