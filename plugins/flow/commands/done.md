...
allowed-tools: Bash(gh pr view:*), Bash(git branch:*), Bash(git worktree:*), Bash(git pull:*), Bash(git rev-parse:*), Bash(cd:*), Bash(ls:*), Bash(ln:*), Bash(for:*), Bash(echo:*), Bash(basename:*), Bash(sed:*), mcp__plugin_linear_linear__get_issue, mcp__claude_ai_Linear__get_issue, mcp__plugin_linear_linear__update_issue, mcp__claude_ai_Linear__save_issue
---
